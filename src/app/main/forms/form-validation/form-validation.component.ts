...
export class FormValidationComponent implements OnInit {
  ...
  barCodeAncienColis;
  listofEtat = [
    'cree', 'enAttenteDEnlevement', 'enCoursDeTransfert', 'enStock', 'enCoursDeLivraison','livre','planificationRetour', 'retourEchange', 'retourne','livrePaye','planificationRetourEchange'
  ];
  fragileList = [
  ...
  listEtat = [
    { value: 'cree', viewValue: 'Crée' }, { value: 'En stock', viewValue: 'enStock' }, { value: 'En stock', viewValue: 'enStock' }, { value: 'enAttenteDEnlevement', viewValue: 'En Attente D enlevement' }
