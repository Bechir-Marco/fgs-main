...
export class FormLayoutComponent implements OnInit {
  ...
  //     this.filelist = [];
  //     this.colisService.importColis(arraylist).subscribe(data=>{
  //       console.log('imported successfully')
  //     })
  //     this.listColisCrees = this.listColisCrees.concat(arraylist);
  //     console.log(this.listColisCrees)
  //   }
  // }
