  ...
  // Forms & Tables
  {
    ...
    children: [
      ...
      },
      {
        ...
        role: ['Admin'],
        icon: 'truck',
        url: 'fournisseurs/list-fournisseurs'
      },
    ...
    
      {
        ...
        children: [
          ...
          },
          {
            ...
            icon: 'plus-square',
            role: ['Admin'],
            url: 'dispatch/ajouter-dispatch'
          },
          {
            id: 'hub',
            title: 'Liste Dispatch',
            translate: 'MENU.UI.COLORS',
            type: 'item',
            icon: 'archive',
            role: ['Admin'],
            url: 'list-dispatch/list-dispatch'
          },
          {
            id: 'runsheet',
            title: 'Gestion Runsheet',
            translate: 'MENU.UI.TYPOGRAPHY',
            type: 'item',
            icon: 'file-text',
            role: ['Admin','Personnel'],
            url: 'runsheet/runsheet'
          },
          {
            id: 'debrief',
            title: 'Gestion Debrief',
            translate: 'MENU.UI.TYPOGRAPHY',
            type: 'item',
            role: ['Admin'],
            icon: 'file-text',
      ...
      {
        id: 'gestion-transfert',
        title: 'Gestion Transfert',
        // translate: 'MENU.APPS.INVOICE.COLLAPSIBLE',
        type: 'collapsible',
        role: ['Admin','Personnel'],
        icon: 'activity',
        children: [
          ...
          {
            id: 'ajouter-console',
            title: 'Ajouter Console',
            translate: 'MENU.CM.MAPS',
            icon: 'box',
            type: 'item',
            role: ['Personnel'],
            url: 'ajouter-console/ajouter-console'
          },
          // {
          //   id: 'gestion-console',
          //   title: 'Ajouter console',
          ...
          // },
          {
            id: 'transfert-sortant',
            title: 'Transfert Sortant',
            translate: 'MENU.UI.COLORS',
            type: 'item',
            role: ['Personnel'],
            icon: 'arrow-left-circle',
            url: 'transfert-sortant/transfert-sortant'
          },
          {
            id: 'transfert-entrant',
            title: 'Transfert Entrant',
            translate: 'MENU.UI.COLORS',
            type: 'item',
            role: ['Personnel'],
            icon: 'arrow-right-circle',
            url: 'transfert-entrant/transfert-entrant'
          },

        ]
      },
      {
        id: 'parametre-generaux',
        ...
        children: [
          ...
          {
            id: 'gestion-anomalie',
            title: 'Gestion Anomalie',
            translate: 'MENU.UI.COLORS',
            type: 'item',
            role: ['Admin'],
            icon: 'tool',
            url: 'anomalie/gestion-anomalie'
          },
        ...
        children: [
          {
            ...
            type: 'item',
            icon: 'repeat',
            url: 'liste-echange/liste-echange'
          },
          {
            id: 'liste-retour',
            title: 'Liste retour',
